    ...
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div>
        <h6 className="
            ...
            flex-col
            md:flex-row">
          <Image alt='Bomb logo' src="/bomblogo.png" height={150} width={150} />
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-100">Settings</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-100">Orders</a>
        </p>
        <p>
          <a href="#!" className="text-gray-100">Help</a>
        </p>
      </div>
    </div>
  </div>
